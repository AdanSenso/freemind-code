...
public class ExpandNodeAction extends AbstractAction {
    ...
    public ExpandNodeAction(MindMapController controller) {
        super(controller.getText("expand_node"));
        System.out.println("19. adan subtree");
        this.controller = controller;
    }

    public void actionPerformed(ActionEvent e) {
        System.out.println("18. adan expand");
        ...
        if (panel != null) {
        panel.appendMessage("[System] Expanding node \"" + nodeId + "\"...", "system");
        }

        // Step 2: Run HTTP request in background
        new Thread(() -> {
            try {
                String url = "/expand_specific_node_claude";
